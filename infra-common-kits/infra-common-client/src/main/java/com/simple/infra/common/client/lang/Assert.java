...
/**
 * @author xulujun copy from spring
 * @date 2018/07/07
 */
public final class Assert {
     ...
     * itself, and which may be used to provide context. It should normally end in a ": " or ". " so
     * that the function generate message looks ok when prepended to it.
     * @throws IllegalArgumentException if the object is not an instance of clazz
     * @see Class#isInstance
     */
